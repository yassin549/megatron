    ...
    theme: {
        extend: {
            ...
            colors: {
                ...
                // Custom "Obsidian" Palette - Lighter Scale
                obsidian: {
                    950: "#090E1A", // Main background (HSL 7%)
                    900: "#0D1426", // Secondary background (HSL 9%)
                    800: "#141C33", // Card background (HSL 11%)
                    700: "#1F2942", // Hover state
                    600: "#2B3852", // Border
                },
                neon: {
