...
export default function SignupPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Auto connect or redirect to login (using redirect for flow clarity)
    ...
    return (
        <div className="min-h-screen grid lg:grid-cols-2 bg-background overflow-hidden">
            ...
            <div className="hidden lg:flex relative flex-col justify-between p-12 bg-obsidian-950 overflow-hidden">
                {/* Background Effects */}
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-neon-purple/20 via-obsidian-900 to-obsidian-950" />
                ...
                <div className="relative z-10 max-w-lg">
                    ...
                    >
                        <h2 className="text-4xl font-bold text-white mb-6 leading-tight">
                            Join the <br />
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-neon-purple to-blue-500">financial revolution.</span>
                        </h2>
            ...
            <div className="flex flex-col items-center justify-center p-6 sm:p-12 relative">
                ...
                <div className="w-full max-w-[400px] space-y-8">
                    <div className="text-center lg:text-left">
                        ...
                        <p className="text-muted-foreground mt-2">Start your trading journey instantly</p>
                    </div>
                    ...
                    <div className="space-y-4">
                        ...
                        {error && (
                            <div className="p-3 rounded-lg bg-red-500/10 border border-red-500/20 text-red-500 text-sm text-center flex items-center justify-center gap-2">
