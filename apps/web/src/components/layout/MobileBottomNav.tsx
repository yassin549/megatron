...
export function MobileBottomNav() {
    ...
    return (
        <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 pointer-events-none">
            <nav className="flex items-center justify-around p-2 pb-8 pointer-events-auto bg-obsidian-950/90 backdrop-blur-2xl border-t border-white/5 rounded-t-[32px] shadow-[0_-10px_40px_rgba(0,0,0,0.6)]">
                {tabs.map((tab) => {
