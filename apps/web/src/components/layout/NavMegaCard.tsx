            ...
            {isOpen && (
                <div className="absolute right-0 top-full mt-4 z-[100] hidden lg:block">
                    ...
                    <motion.div
                        ...
                        className="w-[380px] h-[520px] bg-obsidian-900 border border-white/10 rounded-none shadow-[0_32px_64px_-12px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col nav-popover-content"
                    >
                        {/* Header */}
