...
export function SubNavbar() {
    ...
    return (
        <div className={`sticky top-16 z-40 transition-all duration-200 ${!isVisible ? '-translate-y-[8rem] md:translate-y-0 pointer-events-none' : 'translate-y-0 pointer-events-auto'} bg-surface border-b border-border-subtle shadow-sm`}>
