            ...
            {isOpen && activeTab && (
                <>
                    ...
                    <motion.div
                        ...
                        exit={{ opacity: 0 }}
                        onClick={onClose}
                        className="fixed inset-0 z-[90] bg-black/40 backdrop-blur-[6px] hidden md:block"
                    />
                    ...
                    <div className="absolute right-0 top-full mt-4 z-[100] hidden md:block">
                        <motion.div
                            ...
                            className="w-[380px] h-[520px] glass-panel bg-elevated/40 backdrop-blur-2xl border border-white/10 rounded-xl shadow-[0_32px_64px_-12px_rgba(0,0,0,0.8)] overflow-hidden flex flex-col nav-popover-content"
                        >
                            {/* Header */}
                                ...
                                <div className="flex items-start justify-between">
                                    <div>
                                        ...
                                        <motion.p
                                            ...
                                            initial={{ opacity: 0 }}
                                            animate={{ opacity: 1 }}
                                            className="text-xs text-muted-foreground mt-1 uppercase tracking-widest font-mono p-0"
                                        >
                                            {getDescription()}
                                        </motion.p>
                                    </div>
                            ...
                            <div className="flex-1 overflow-y-auto custom-scrollbar relative">
                                <AnimatePresence mode="wait">
                                    <motion.div
                                        ...
                                        className="relative w-full p-6 pb-8"
                                    >
                                        {children}
                                    </motion.div>
                                </AnimatePresence>
